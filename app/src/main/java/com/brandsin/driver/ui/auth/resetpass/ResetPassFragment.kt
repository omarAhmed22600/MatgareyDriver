...
import com.brandsin.driver.databinding.AuthFragmentResetBinding
...
class ResetPassFragment : BaseAuthFragment(), Observer<Any?>
{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?)
    {
        ...
        val secondFragmentArgs: ResetPassFragmentArgs =
            ResetPassFragmentArgs.fromBundle(requireArguments())
