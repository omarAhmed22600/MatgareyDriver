...
import com.brandsin.driver.databinding.ActivityMapsBinding
...
import com.brandsin.driver.ui.dialogs.permission.DialogPermissionFragment
...
class MapActivity : AppCompatActivity(), OnMapReadyCallback, Observer<Any?> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        driver = intent.getBooleanExtra("driver",false)
        if (driver) {
            ...
            Codes.ACCESS_LOCATION_REQUEST_CODE -> {
                ...
                when {
                    grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED -> {
                        ...
                        when {
                            ActivityCompat.shouldShowRequestPermissionRationale(this@MapActivity,
    ...
    {
        GpsUtils(this@MapActivity).turnGPSOn(object : GpsUtils.onGpsListener {
                ...
                Codes.CONFIRM_CLICKED -> {
                    if (!driver) {
                        ...
                        */
                        ...
                        setResult(Codes.SHOW_DRIVER_LOCATION, intent)
                        finish()
                    }
                }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?)
    {
        ...
        when (requestCode)
        {
            ...
            Codes.ALLOW_PERMISSION_FROM_SETTING_PAGE -> {
                when {
                    PermissionUtil.isGranted(this@MapActivity, Manifest.permission.ACCESS_FINE_LOCATION) -> {
